...
if (displayParty) {
    def shipToContactMechList = ContactHelper.getContactMech(displayParty, "PHONE_SHIPPING", "TELECOM_NUMBER", false)
    ...
    def billToContactMechList = ContactHelper.getContactMech(displayParty, "PHONE_BILLING", "TELECOM_NUMBER", false);
