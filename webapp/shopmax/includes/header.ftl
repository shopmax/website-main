...
<header id="topnav" class="navbar navbar-inverse navbar-fixed-top clearfix">
    <div class="navbar-inner">
        <div class="container">
            ...
            <h1 title="Shopmax"><a class="brand" href="${shopmaxCentralDomain}main"><img src="<@ofbizContentUrl>/shopmax-default/img/logo-2.png</@ofbizContentUrl>" width="159" height="55" alt="Shopmax logo" /></a></h1>
