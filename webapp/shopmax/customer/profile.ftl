            ...
            <div id="profile-tab" class="tabcontent">
                <div class="inside">
                    ...
                    <div class="span3">
                        ...
                        <ul><li><a href="#"><img src="<@ofbizContentUrl>shopmax-default/img/fb.png</@ofbizContentUrl>" width="23" height="23" alt="" /></a></li>
                        <li><a href="#"><img src="<@ofbizContentUrl>shopmax-default/img/tw.png</@ofbizContentUrl>" width="23" height="23" alt="" /></a></li>
                        <li><a href="#"><img src="<@ofbizContentUrl>shopmax-default/img/gplus.png</@ofbizContentUrl>" width="23" height="23" alt="" /></a></li></ul>
                    </div>
                </div>
                <div class="inside">
                    <h4>Password</h4>
                ...
                <div id="merchant-tab" class="tabcontent">
                    ...
                    <h4>Business Details<span><a class="box-link" href="#">Edit</a></span></h4>
                        ...
                        <div class="span9">
                            ...
                            <tr><td colspan="1" class="align-left">
                                    <input type="checkbox" checked="checked" name="usedomname" id="usedomname">
                                </td>
                                <td colspan="11">
                                    <label for="domname">Use your own domain name</label></td>
                            ...
                            <tr>
                                <td colspan="8">
                                    <label for="accntnum">Account number</label></td>
