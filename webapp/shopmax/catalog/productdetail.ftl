...
<div class="container content">
    <div>
        <ul class="breadcrum"><li><a href="/">Home</a></li>
        <li>Shop</li><li>Shop name</li></ul>
    </div>
    <div class="row content-left">
    <!-- MAIN CONTENT -->
        <!-- sliderdiv -->
        <div class="span12">
            <div class="shop-logo"><img src="<@ofbizContentUrl>/shopmax-default/img/shop-logo.jpg</@ofbizContentUrl>" /></div>
    ...
    <div class="product-related">
        <h3 class="georgia">Related Products</h3>
        <div class="row content-left" style="padding-left:30px;">
            <div class="span4">
                <div class="product-related-wrapper">
                    <div class="product-related-inner">
                        <img src="<@ofbizContentUrl>/shopmax-default/img/product-generic-281x281.jpg</@ofbizContentUrl>" />
                    </div>
                </div>
                <h5 class="name">Product name</h5>
                <h5 class="price">$120</h5>
                <div class="view-detail">
                    <p><a class="btn-general" href="#">View Details</a></p>
    ...
    <div class="product-related">
        <h3 class="georgia">Customers who bought this product also bought...</h3>
        <div class="row content-left" style="padding-left:30px;">
            <div class="span3">
                <div class="product-related-wrapper">
                    <div class="product-related-inner">
                        <img src="<@ofbizContentUrl>/shopmax-default/img/product-generic-208x208.jpg</@ofbizContentUrl>" />
                    </div>
                </div>
                <h5 class="name">Product name</h5>
                <h5 class="price">$120</h5>
