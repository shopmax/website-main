...
(function(b) {
    ...
    var domainNameUrl = curentUrl.split(".");
    var domainPort = domainNameUrl[1].split("/");
    var domainType = "";
    if(domainNameUrl[3]){
        domainType = domainNameUrl[3];
    }
    var imageUrlPath = imageUrlPath = domainNameUrl[0]+"backend."+domainPort[0]+domainType
    var a = {
        init : function(c) {
            return this
                    .each(function() {
