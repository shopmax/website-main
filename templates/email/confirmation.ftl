            ...
            <tr>
                <td valign="top" align="left">
                    <table width="730" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td valign="top"  align="left"  height="48" style="padding:0 0 0 18px"><a href="#"><img src="<@ofbizContentUrl>/shopmax-default/img/logo-img.png</@ofbizContentUrl>" width="202" height="57" alt="img" border="0" align="left"></a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td valign="top" align="left" height="0" width="730"> <img src="<@ofbizContentUrl>/shopmax-default/img/border-img.gif</@ofbizContentUrl>" width="727" height="1" alt="line" border="0" align="left"></td>
                        </tr>
                    </table>
                    <table width="730" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                    ...
                    <table width="730"  cellspacing="0" cellpadding="0" >
                        <tr>
                            <td valign="top"  align="left"  height="39"><a href="#"><img src="<@ofbizContentUrl>/shopmax-default/img/order-img.jpg</@ofbizContentUrl>" width="732" height="39" alt="img" border="0" align="left"></a></td>
                        </tr>
                    </table>
